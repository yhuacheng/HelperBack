<template>
	<section>
		...
		<!-- 导入 -->
		<el-dialog title="【首页无差评】文件导入" :visible.sync="drModal" :close-on-click-modal="false" :before-close="closeDrModal"
		 width="30%">
			<el-form ref="drForm" class="txt-c">
				<el-upload ref="upload" :limit="1" drag action="/api/BackPagNoBadEvaluate/ExcelPagNoBadEvaluate" multiple
