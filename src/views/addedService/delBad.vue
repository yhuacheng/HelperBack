<template>
	<section>
		...
		<el-table v-show="false" :data="tableData" style="width: 100%" id="out-table">
			...
			<el-table-column prop="ReviewLink" label="ReviewLink" align="center"></el-table-column>
		...
		<!-- 导入 -->
		<el-dialog title="【删差评】文件导入" :visible.sync="drModal" :close-on-click-modal="false" :before-close="closeDrModal" width="30%">
			<el-form ref="drForm" class="txt-c">
				<el-upload ref="upload" :limit="1" drag action="/api/BackBadEvaluate/ExcelUserByBackBad" multiple :on-success="handleAvatarSuccess"
