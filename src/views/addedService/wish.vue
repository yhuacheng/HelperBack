<template>
	<section>
		 ...
		 id="tableData" ref='tableData'>
			...
			<el-table-column label="截图" align="center">
				<template v-slot="scope">
					<el-link type="primary" :underline="false" :href="scope.row.Files" v-if="scope.row.Files">
						{{scope.row.Files}} <i class="el-icon-download"></i>
					</el-link>
				</template>
			</el-table-column>
		...
		<!-- 导入 -->
		<el-dialog title="【心愿单】上传截图" :visible.sync="drModal" :close-on-click-modal="false" :before-close="closeDrModal" width="30%">
